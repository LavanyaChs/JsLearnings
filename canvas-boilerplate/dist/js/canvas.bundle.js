...
var Ball = /*#__PURE__*/function () {
  ...
  _createClass(Ball, [{
    key: "draw",
    value: function draw() {
      c.beginPath(); // c.arc(this.x, this.y, this.radius, 0, 2*Math.PI, false);
      ...
      c.lineTo(this.x, this.y);
      c.strokeStyle = this.color; // c.moveTo(this.x,this,y);
...
function init() {
  objects = []; // ball = new Ball(canvas.width / 2, canvas.height / 2, 2, 30, 'red');
  // console.log(ball);
  // let radius = 30

  for (var i = 0; i < 200; i++) {
    var radius = _utils__WEBPACK_IMPORTED_MODULE_0___default.a.randomIntFromRange(8, 20);
    var x = _utils__WEBPACK_IMPORTED_MODULE_0___default.a.randomIntFromRange(30, canvas.width - radius);
    var y = _utils__WEBPACK_IMPORTED_MODULE_0___default.a.randomIntFromRange(30, canvas.height - radius);
